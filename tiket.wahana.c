     ...
     if (pil1 == 1)
                {
                    ...
                    else if (tiket[j].usia >= 14 && strcmp(tiket[j].penyakit, "hipertensi") != 0 && strcmp(tiket[j].penyakit, "jantung") != 0)
                    {
                    ...
                    else if (tiket[j].usia >= 16 && strcmp(tiket[j].penyakit, "jantung") != 0 && tiket[j].tb >= 150 && strcmp(tiket[j].penyakit, "hipertensi") != 0)
                    {
                    ...
                    else if (tiket[j].usia >= 10 && strcmp(tiket[j].penyakit, "jantung") != 0)
                    {
                    ...
                    else if (tiket[j].usia >= 10 && strcmp(tiket[j].penyakit, "jantung") != 0 && strcmp(tiket[j].penyakit, "anemia") != 0 && tiket[j].tb >= 130)
                    {
                        ...
                        printf("TIDAK ADA WAHANA YANG COCOK");
                    }
                }
    else if (pil1==2){
     system ("cls");
